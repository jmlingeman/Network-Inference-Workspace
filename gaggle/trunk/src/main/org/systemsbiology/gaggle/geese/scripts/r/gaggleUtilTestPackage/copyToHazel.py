# copyToHazel.py:  create a fresh copy of the gaggleUtilTest R package, creating a new
...
targetDirectory = '/users/pshannon/work/r/gaggleUtilTest-package-%s' % suffix
