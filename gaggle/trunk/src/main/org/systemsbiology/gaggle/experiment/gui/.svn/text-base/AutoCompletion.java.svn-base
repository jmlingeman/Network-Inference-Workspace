...
public class AutoCompletion extends PlainDocument {
    ...
    public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
        ...
        // new code from http://www.orbital-computer.de/JComboBox/#nonstrict starts here:
...
/*
old (default) strict code that doesn't let you type anything that isn't in the list:
...
/*
//commented out now that we have gone non-strict.
//if for some reason we want to go strict again, uncomment this
