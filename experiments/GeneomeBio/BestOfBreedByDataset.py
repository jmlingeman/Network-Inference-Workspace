...
inf.setup(None, wildtypes[exp_name], settings, ts_storage, None, "Inferelator2_Time_Series".format(meth, exp_name), goldnet)
jobman.queueJob(inf)
...
settings["inferelator2"]["method"] = meth
inf.setup(None, wildtypes[exp_name], settings, ts_storage, multifactorials[exp_name], "Inferelator2_Multifactorial".format(meth, exp_name, "genie3"), goldnet)
jobman.queueJob(inf)
...
settings["inferelator2"]["percfp"] = 0
settings["inferelator2"]["method"] = meth
inf.setup(knockouts[exp_name], wildtypes[exp_name], settings, ts_storage, None, "Inferelator2_Knockout".format(meth, exp_name, "genie3"), goldnet)
jobman.queueJob(inf)
...
settings["inferelator2"]["percfp"] = percfp
settings["inferelator2"]["method"] = meth
inf.setup(None, wildtypes[exp_name], settings, ts_storage, multifactorials[exp_name], "Inferelator2_Genie3_Prior".format(meth, exp_name, "genie3"), goldnet, genie3net)
jobman.queueJob(inf)
...
settings["inferelator2"]["percfp"] = percfp
settings["inferelator2"]["method"] = meth
inf.setup(knockouts[exp_name], wildtypes[exp_name], settings, ts_storage, None, "Inferelator2_MCZ_Prior".format(meth, exp_name, "mcz"), goldnet, mcznet)
jobman.queueJob(inf)
...
settings["inferelator2"]["percfp"] = 0
settings["inferelator2"]["method"] = meth
inf.setup(knockouts[exp_name], wildtypes[exp_name], settings, ts_storage, multifactorials[exp_name], "Inferelator2_All_Data".format(meth, exp_name, "mcz"), goldnet)
jobman.queueJob(inf)
