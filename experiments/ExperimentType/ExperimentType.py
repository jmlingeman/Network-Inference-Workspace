...
multifactorial_filename = exp_set + '-1_nonoise_multifactorial.tsv'
...
genie3job = GENIE3()
genie3job.setup(pert_data["multifactorial_data"], settings, "Genie3_Pert_Only")
jobman.queueJob(genie3job)
pertgenie3 = genie3job

genie3job = GENIE3()
genie3job.setup(ts_pert_data["multifactorial_data"], settings, "Genie3_HalfPert_Only")
jobman.queueJob(genie3job)
halfpertgenie3 = genie3job
...
inf.setup(ts_only_data["multifactorial_data"], ts_only_data["ss_data"], settings, ts_only_data["timeseries"], None, "Inferelator2_TSOnly", None, prior=None, split_ts=True, leave_outs=None)
...
settings["inferelator2"]["perctp"] = 0
settings["inferelator2"]["percfp"] = 0
settings["inferelator2"]["prior_weight"] = 0.2
settings["inferelator2"]["method"] = meth
settings["global"]["time_series_delta_t"] = 100.0
inf.setup(ts_pert_data["multifactorial_data"], ts_pert_data["ss_data"], settings, ts_pert_data["timeseries"], None, "Inferelator2_TSPert-Prior", None, prior=halfpertgenie3.network, split_ts=True, leave_outs=None)
...
settings["inferelator2"]["method"] = meth
settings["global"]["time_series_delta_t"] = 100.0
inf.setup(ts_pert_data["multifactorial_data"], ts_pert_data["ss_data"], settings, ts_pert_data["timeseries"], None, "Inferelator2_TSPert-NoPrior", None, prior=None, split_ts=True, leave_outs=None)
#inf.setup(None, ss_data, settings, [kcl_ts_data], None, "Inferelator2_TS_SS".format(meth, "inf_test"), prior=genie3job.network, split_ts=False, gold_std=None, leave_outs=leave_out)
jobman.queueJob(inf)
