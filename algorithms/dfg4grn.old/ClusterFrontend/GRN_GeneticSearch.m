...
function [child1, child2] = Crossover(parent1, parent2, ...
    ...
    %if n > 10        % As n shrinks, the search space narrows in
    %    n = 4;
    %else
    %    n = n / 2;
    %end
    ...
    % This is here to eliminate dupes, but might need to be stronger.
    if (child1.params.tau == parent1.params.tau && ...
            child1.params.lambda_w == parent1.params.lambda_w && ...
            child1.params.gamma == parent1.params.gamma) || ...
       (child1.params.tau == parent2.params.tau && ...
            child1.params.lambda_w == parent2.params.lambda_w && ...
            child1.params.gamma == parent2.params.gamma)
        
        child1 = random_child(gamma_range, lambda_w_range, tau_range);
        
    end
    
    if (child2.params.tau == parent1.params.tau && ...
            child2.params.lambda_w == parent1.params.lambda_w && ...
            child2.params.gamma == parent1.params.gamma) || ...
       (child2.params.tau == parent2.params.tau && ...
            child2.params.lambda_w == parent2.params.lambda_w && ...
            child2.params.gamma == parent2.params.gamma)
        
        child2 = random_child(gamma_range, lambda_w_range, tau_range);
...
% -------------------------------------------------------------------------
function [child] = random_child(gamma_range, lambda_w_range, tau_range)
        child = new_child();
        child.params.lambda_w = lambda_w_range(1) + ...
            ((rand * lambda_w_range(2)) - lambda_w_range(1));
        child.params.tau = tau_range(1) + ...
