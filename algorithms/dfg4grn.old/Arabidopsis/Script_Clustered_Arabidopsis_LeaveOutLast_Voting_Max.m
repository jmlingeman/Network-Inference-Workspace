% Load the dataset
[geneNames, KNO3, tfs, deltaT] = GRN_ClusterGenes_Voting_Max('Arabidopsis_n550.mat',...
    'top50-corr-clusterList.csv');
n_seq = 4;

% Initialize the parameters
params = DFG_Params_Default_Arabidopsis(length(geneNames), 67, geneNames);
