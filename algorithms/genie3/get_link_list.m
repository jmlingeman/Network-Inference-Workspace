...
%
%get_link_list(VIM) writes the ranked list of all putative
%regulatory links. 
%VIM is a weighted adjacency matrix as returned by GENIE3. VIM(i,j) is the 
%weight of edge directed from the ith gene to the jth gene. 
%Self interactions do not appear in the list. Regulatory links with a 
...
%The default vector contains the indexes of all genes in VIM.
%
...
%ranked list of regulatory links to file filename.
