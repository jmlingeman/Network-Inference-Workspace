% Create the clustered dataset from our already gotten clusters
[geneNames, KNO3, tfs, deltaT] = GRN_ClusterGenes('Arabidopsis_n550.mat',...
    '550gene_cluster_noTF.csv');
...
params = DFG_Params_Default_Arabidopsis(134, 67, geneNames);
