...
function xmin=purecmaes(script_name, out_dir, num_models, meas_name, ...
  par1, var1range, par2, var2range, par3, var3range)   % (mu/mu_w, lambda)-CMA-ES 
 
  % --------------------  Initialization --------------------------------  
  % User defined input parameters (need to be edited)
  strfitnessfct = 'GRN_Batch_MultiModel_AR1';  % name of objective/fitness function
