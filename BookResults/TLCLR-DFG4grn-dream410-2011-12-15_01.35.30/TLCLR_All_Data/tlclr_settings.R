...
PARAMS[["general"]][["data"]] <- "TLCLR_All_Data"
PARAMS[["general"]][["output_file"]] <- "../output/tlclr_output.csv"
#############################################################################
...
PARAMS[["general"]][["saveToDir"]] = paste("../output/",PARAMS[["general"]]$data,"_",
...
if ('/Users/jesse/Workspace/School/MastersThesis/Program/output//TLCLR-DFG4grn-dream410-2011-12-15_01.35.30//TLCLR_All_Data//data//Timeseries-Rep0.csv' != 'None') {
    ts_filename = '/Users/jesse/Workspace/School/MastersThesis/Program/output//TLCLR-DFG4grn-dream410-2011-12-15_01.35.30//TLCLR_All_Data//data//Timeseries-Rep0.csv'
} else {
    ts_filename = ''
}
print("Loading KO data\n")
if ('/Users/jesse/Workspace/School/MastersThesis/Program/output//TLCLR-DFG4grn-dream410-2011-12-15_01.35.30//TLCLR_All_Data//data//inSilico_size10_1_knockouts.tsv' != 'None') {
    ko_filename = '/Users/jesse/Workspace/School/MastersThesis/Program/output//TLCLR-DFG4grn-dream410-2011-12-15_01.35.30//TLCLR_All_Data//data//inSilico_size10_1_knockouts.tsv'
} else {
    ko_filename = ''
}

print("Loading KD data\n")
if ('/Users/jesse/Workspace/School/MastersThesis/Program/output//TLCLR-DFG4grn-dream410-2011-12-15_01.35.30//TLCLR_All_Data//data//inSilico_size10_1_knockdowns.tsv' != 'None') {
    kd_filename = '/Users/jesse/Workspace/School/MastersThesis/Program/output//TLCLR-DFG4grn-dream410-2011-12-15_01.35.30//TLCLR_All_Data//data//inSilico_size10_1_knockdowns.tsv'
} else {
    kd_filename = ''
}

print("Loading WT data\n")
if ('/Users/jesse/Workspace/School/MastersThesis/Program/output//TLCLR-DFG4grn-dream410-2011-12-15_01.35.30//TLCLR_All_Data//data//inSilico_size10_1_wildtype.tsv' != 'None') {
    wt_filename = '/Users/jesse/Workspace/School/MastersThesis/Program/output//TLCLR-DFG4grn-dream410-2011-12-15_01.35.30//TLCLR_All_Data//data//inSilico_size10_1_wildtype.tsv'
} else {
    wt_filename = ''
}

ratios <- makeRatios(chalName,ts_filename, ko_filename, kd_filename, wt_filename)
...
obj = list()
tfNames <- load_tfnames('None', ratios)
obj[[1]] = ratios
obj[[2]] = clusterStack
obj[[3]] = colMap
obj[[4]] = tfNames
